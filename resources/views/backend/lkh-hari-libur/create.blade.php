...
<div class="panel shadow-sm">
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            {!! html()->text('keterangan')->placeholder('Contoh: Hari Raya Idul Fitri')->class('form-control')->id('keterangan') !!}
        </div>
    </div>
</div>
...
{!! html()->form()->close() !!}
<script>
    $('.modal-title').html('<i class="fa fa-plus-circle"></i> Tambah Hari Libur');
