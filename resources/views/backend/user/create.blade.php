    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                {!! html()->text('last_name')->placeholder('Ketik disini ...')->class('form-control')->id('last_name') !!}
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <span class="text-danger">*</span>
                {!! html()->text('nip')->placeholder('Ketik disini ...')->class('form-control')->id('nip')->required() !!}
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Jabatan','jabatan')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('jabatan', config('master.app.jabatan'))->class('form-control select2')->id('jabatan')->required() !!}
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Subbagian','subbagian')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('subbagian', config('master.app.subbagian'))->class('form-control select2')->id('subbagian')->required() !!}
           
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Atasan','atasan_id')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('atasan_id', $atasan)->class('form-control select2')->id('atasan_id') !!}
            </div>
        </div>       
