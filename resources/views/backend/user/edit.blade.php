    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                {!! html()->text('last_name',$data->last_name)->placeholder('Ketik disini ...')->class('form-control')->id('last_name') !!}
            </div>
        </div>
        @if($data->id != $user->id)
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <span class="text-danger">*</span>
                {!! html()->text('nip',$data->nip)->placeholder('Ketik disini ...')->class('form-control')->id('nip')->required() !!}
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Jabatan','jabatan')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('jabatan', config('master.app.jabatan'), $data->jabatan)->class('form-control select2')->id('jabatan')->required() !!}
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Subbagian','subbagian')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('subbagian', config('master.app.subbagian'), $data->subbagian)->class('form-control select2')->id('subbagian')->required() !!}
            </div>
            <div class="col-md-6 form-group">
                {!! html()->label('Atasan','atasan_id')->class('control-label') !!}
                <span class="text-dark"></span>
                {!! html()->select('atasan_id', $atasan, $data->atasan_id)->class('form-control select2')->id('atasan_id') !!}
            </div>
        </div>
        @endif
