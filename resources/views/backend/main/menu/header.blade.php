<header class="main-header">
    <div class="d-flex align-items-center logo-box justify-content-start">
        ...
        <a href="#" class="logo p-0">
            <div class="logo-lg">
                <i class="light-logo"><img src="{{ url($template).config('master.app.web.logo_light')}}" alt="logo" width="180"></i>
                <i class="dark-logo"><img src="{{ url($template).config('master.app.web.logo_dark')}}" alt="logo" width="180"></i>
